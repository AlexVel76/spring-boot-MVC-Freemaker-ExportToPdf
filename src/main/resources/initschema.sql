...
create table User (id bigint not null, birthdate varchar(255), description varchar(255), email varchar(255), firstName varchar(255), lastName varchar(255), luckyUser boolean not null, primary key (id));
